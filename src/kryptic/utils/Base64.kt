...
fun String64(string:String?, encode:Boolean=true) = String64(string?.toByteArray(), encode)
fun String64(bytes:ByteArray?, encode:Boolean=true) = if (bytes != null) String(if(encode) bytes.encode() else bytes.decode()) else ""


fun Bytes64(string:String?, encode:Boolean=true) = Bytes64(string?.toByteArray(), encode)
fun Bytes64(bytes:ByteArray?, encode:Boolean=true) = if (bytes != null) if(encode) bytes.encode() else bytes.decode() else ByteArray(0)


private fun ByteArray.encode(): ByteArray {
...
private fun ByteArray.decode(): ByteArray {
